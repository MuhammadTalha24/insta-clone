            ...
            <div className='flex w-screen h-screen justify-center items-center'>
                <form onSubmit={signupHandler} className='shadow-lg flex flex-col gap-5 p-8'>
                    <div className='my-4 flex flex-col items-center'>
                        ...
                        <p className='text-[18px] mx-5  mt-5'>Sign Up To See Photos & Videos From Your Friends</p>
                    </div>
                    <div className='flex flex-col gap-3'>
                        <Label htmlFor='username'>Username</Label>
                        <Input name='username' value={formdata.username} type='text' onChange={submitHandler} />
                    </div>
                    <div className='flex flex-col gap-3'>
                    ...
                    <h6 className='text-center'>Already Have An Account? <Link to={'/login'} className='text-blue-500'>Login</Link></h6>
